...
let tempoDecorridoEmSegundos = 1500; //1500 segundos para 25 minutos
...
function iniciarOuPausar() {
    ...
    intervaloId = setInterval(contagemRegressiva, 1000); //recebe valor em milisegundos, 1000 = 1 segundo
    musicaStart.play();
